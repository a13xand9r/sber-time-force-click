...
export const runAppHandler: SaluteHandler = ({ req, res, session }) => {
  ...
  res.setPronounceText(`${req.request.payload.character.appeal === 'official' ? 'Здравствуйте, я помогу вам' : 'Привет, я помогу тебе'} начать лучше чувствовать время. В настройках можно изменить таймер и начать играть. При текущих настройках нужно самому отсчитывать и нажимать на кнопку каждые 5 секунд.`)
  res.appendBubble(`${req.request.payload.character.appeal === 'official' ? 'Здравствуйте, я помогу вам' : 'Привет, я помогу тебе'} начать лучше чувствовать время. В настройках можно изменить таймер и начать играть. При текущих настройках нужно самому отсчитывать и нажимать на кнопку каждые 5 секунд.`)
}
