    ...
    switch (tab) {
      case 'Правила':
        return <TextBox>
          ...
          За каждое нажатие вовремя {character === 'joy' ? 'тебе' : 'вам'} начисляется балл. Отсчет времени начинается после звукового сигнала, когда кнопка Клик становится доступной.
        </TextBox>
      case 'Играть':
        return <TextBox>
            {playContent}
